    ...
    <Modal visible={modalVisible} animationType={'fade'} transparent statusBarTranslucent>
      <View style={styles.overlay}>
        ...
        <Animated.View style={{...styles.bottomSheetContainer, transform: [{translateY: translateY}]}} {...panResponders.panHandlers}>
          <Text style={[styles.ButtonText, {color: '#000000', fontWeight: '900', fontSize: 16, letterSpacing: 0.2}]}>이런 사진이 좋아요!</Text>
          <Text style={[styles.ButtonText, {color: '#000000', fontWeight: '200', fontSize: 12, letterSpacing: 0.1}]}>
            배달 받은 음식을 직접 촬영하여 올려주세요.
          </Text>
          <Text style={[styles.ButtonText, {color: '#000000', fontWeight: '200', fontSize: 12, letterSpacing: 0.1}]}>
            음식의 포장 상태를 알려주시는 것도 좋아요.
          </Text>
          ...
          <TouchableOpacity style={styles.SubmitButton} onPress={getPhoto}>
            <Text style={styles.ButtonText}>사진 찍기</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.SubmitButton} onPress={getGallery}>
